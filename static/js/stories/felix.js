$(document).ready(function () {
  ...
  const pageBackgrounds = [
    "/static/images/stories/Felixfox/Felixfox_page1.png", // Cover
    "/static/images/stories/Felixfox/Felixfox_page1.png", // page 1
    "/static/images/stories/Felixfox/Felixfox_page2.png", // page 2
    "/static/images/stories/Felixfox/Felixfox_page3.png", // page 3
    "/static/images/stories/Felixfox/Felixfox_page4.png", // page 4
    "/static/images/stories/Felixfox/Felixfox_page5.png", // page 5
    "/static/images/stories/Felixfox/Felixfox_page6.png", // page 6
    "/static/images/stories/Felixfox/Felixfox_page7.png", // page 7
    "/static/images/stories/Felixfox/Felixfox_page8.png", // page 8
    "/static/images/stories/Felixfox/Felixfox_page9.png", // page 9
    "/static/images/stories/Felixfox/Felixfox_page10.png", // page 10
    "/static/images/stories/Felixfox/Felixfox_page11.png", // page 11
    "/static/images/stories/Felixfox/Felixfox_page12.png", // page 12
    "/static/images/stories/Felixfox/Felixfox_page13.png", // page 13
    "/static/images/stories/Felixfox/Felixfox_page14.png", // page 14
  ];

  // Page turn sound effects
  const pageTurnSounds = [
    document.getElementById("page-turn-1"),
    document.getElementById("page-turn-2"),
    document.getElementById("page-turn-3")
  ];

  // Function to play random page turn sound
  function playPageTurnSound() {
    const randomIndex = Math.floor(Math.random() * pageTurnSounds.length);
    const sound = pageTurnSounds[randomIndex];
    if (sound) {
